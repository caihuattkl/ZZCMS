...
module.exports = {
	...
	'/admin/infoRepertoryEdit': {
		get: "news.infoRepertoryEdit"
	},
	/*
	报告页面相关
	 * */
...
//		delete: "api_boffins.del",
	...
	/*
	 * 
	 api接口 news 新闻api,信息库
	 * */
	'/api/infoRepertorys': {
		get:"api_news.infoRepertoryList",
		post: "api_news.infoRepertoryAdd"
	},
	'/api/infoRepertory/:id': {
		get: "api_news.infoRepertoryDetail",
		post: "api_news.infoRepertoryToNews"
	},
	'/api/news': {
		put: "api_news.put",
		post: "api_news.add"
