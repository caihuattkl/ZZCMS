...
exports.articles = function(req, res, callback) {
	...
	var sql = ['SELECT title,description,keywords,subTitle,subKeywords,nContent,newsUrl,time from news where newsUrl ="' + url + '"' +
		'UNION ALL SELECT null,null,b.id,b.subTitle,b.directoryName,null,null,null FROM news a,news_class b where a.classFirstId=b.id and a.newsUrl ="' + url + '"' +
		'UNION ALL SELECT null,null,b.id,b.subTitle,b.directoryName,null,null,null FROM news a,news_class b where a.classChildId=b.id and a.newsUrl ="' + url + '"', 
